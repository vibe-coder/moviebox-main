    ...
    <section className='p-6 md:p-16'>
      ...
      <div className='flex border-b border-neutral mb-10 overflow-scroll no-scrollbar'>
        <div className='flex lg:justify-between'>
          {/* Category button */}
          <div className='flex gap-2 w-[200vw] md:gap-6 md:w-[140vw] lg:w-full '>
          ...
          {/* View All selection */}
          <div className='flex justify-end items-center lg:flex-1 lg:w-[600px]'><button className='pb-12 h-6 w-28 font-sans text-yellow-1 border-b-2 border-transparent hover:border-yellow-1 md:text-lg'>View All</button></div>
        </div>
      </div>
      ...
      <div id='movieBanner' className='flex flex-col gap-3 md:flex-col lg:flex-row'>

        {/* Left Section */}
        <div className='sm:w-full relative rounded-lg h-[300px] md:h-[400px] lg:w-[75%] lg:flex-2'>
          ...
          <div className='absolute bg-transparetNeutral w-full h-full flex items-center py-6 pl-6 z-[2]'>
            <div>
              {/* Title */}
              <h1 className='text-white font-bold font-sans text-3xl m-0 md:text-4xl lg:text-5xl'>CHARLIE'S ANGELS</h1>
              {/* Description */}
              <p className='font-sans text-sm m-0 text-white md:text-[16px] lg:text-xl'>Action, Adventure, Comedy | 15 November 2019 (USA)</p>
              {/* Rating */}
              <div className='mt-4 text-white'><div className='border-2 border-yellow-1 w-12 rounded flex justify-center items-center lg:h-9 lg:w-14'>4.0</div></div>
              {/* Button Wrapper */}
        ...
        {/* Right Section */}
        <div id='rightSection' className='flex-[1] w-full text-white bg-midnigh border border-neutral-2 rounded-md bg-gradient-to-t from-neutral to-transparent md:w-[50%] lg:flex-1'>
          <div className='p-6'>
