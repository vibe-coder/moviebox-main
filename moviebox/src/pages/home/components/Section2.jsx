  ...
  return (
    <section className='p-6'>
      ...
      <div className='flex border-b border-neutral mb-10 overflow-scroll no-scrollbar'>
        <div className='flex'>
          {/* Category button */}
          <div className='flex gap-2 w-[200vw]'>
      ...
      <div id='movieBanner' className='flex flex-col gap-3'>

        {/* Left Section */}
        <div className='bg-purple w-92 relative rounded-lg h-[300px]'>
          <img src={bgPoster} alt="bacground poster" className='object-cover object-center w-full h-full absolute rounded-lg z-[1]'/>

          <div className='absolute bg-transparetNeutral w-full h-full flex items-end py-6 pl-6 z-[2]'>
            <div>
              {/* Title */}
              <h1 className='text-white font-bold font-sans text-3xl m-0'>CHARLIE'S ANGELS</h1>
              {/* Description */}
              <p className='font-sans text-sm m-0 text-white'>Action, Adventure, Comedy | 15 November 2019 (USA)</p>
              {/* Rating */}
