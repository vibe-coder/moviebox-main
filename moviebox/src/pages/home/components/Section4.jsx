    ...
    <section className='bg-black px-6 pb-32 '>
      ...
      <div className='grid grid-cols-1 gap-6'>
        ...
        <div className='flex col-soan-1'>
          {/* Picture */}
          <div className='w-[1000px] h-[180px] bg-metal'>
          ...
          <div className=' ml-6 overflow-hidden'>
            ...
            <p className='font-sans mb-4 text-neutral-300 font-hairline text-ellipsis whitespace-pre-wrap overflow-hidden line-clamp-3'>Naomi Scott is a multi-talented actor, singer and songwriter. She stars as "Jasmine"
