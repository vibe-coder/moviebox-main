...
function Nav() {
  return (
    <>
      <nav className="w-100% h-28 flex gap-4 justify-between absolute top-0 left-0 right-0 items-center px-6 z-10">
        <Link className='' to="/">
          <h1 className='text-white text-xl font-bold m-0 flex-1 font-sans focus:outline-none focus-visible:ring'>
        ...
        <Link to="/category">
          <button className='h-10 w-20 rounded text-black font-bold border border-yellow-1 bg-yellow-1 hover:bg-yellow-2 hover:border-yellow-2'>
            Category
          </button>
        </Link>
      </nav>
