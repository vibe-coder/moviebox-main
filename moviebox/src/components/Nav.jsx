...
function Nav() {
  return (
    <>
      <nav className="w-100% h-28 flex gap-4 justify-between absolute top-0 left-0 right-0 items-center px-6 z-10 md:gap-8 md:px-16 md:h-40 ">
        <Link className='' to="/">
        ...
        <label className="relative block w-full md:w-50">
