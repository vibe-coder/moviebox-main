...
import bgPoster from "../images/bg.jpg"
...
function Nav() {
  ...
  return (
    <section className='fixed z-[11] right-0 left-0 h-40 flex justify-center items-center'>
      <div className='w-full'>

        <nav className="w-full flex gap-4 justify-between items-center px-6 md:gap-8 md:px-16 lg:px-28 relative z-[15]">
          <Link className='' to="/">
      ...
      {/* Serch Results */}
      {focus && 
        <div className='bg-neutral-800 text-white fixed h-screen top-0 lg:pt-40 lg:px-28 overflow-hidden'>
              ...
              <div className='text-white mt-2 grid grid-cols-2 gap-x-4 gap-y-11 md:grid-cols-3 lg:grid-cols-6 lg:gap-x-5'>
                {
                  movieData.map((data) => {
                    return(
                      <div className=' h-[19rem] w-[100%] md:h-[20rem] flex-col justify-between lg:h-[20rem] relative z-10 hover:cursor-pointer' >
